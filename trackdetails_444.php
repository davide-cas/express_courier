                  ...
                  <div class="col-xl-5 col-lg-5">
                      ...
                      <table>
                        ...
                        $sql = "SELECT C.ID_Corriere, E.Citta, MT.Destinazione, MT.Citta_Corrente, C.Stato_Consegna
                                ...
                                WHERE C.ID_Ordine=444 AND C.ID_Corriere=MT.ID_Corriere AND E.ID_Magazzino=4 AND E.ID_Magazzino=M.ID_Magazzino AND E.ID_Ecommerce=M.ID_Ecommerce AND E.Citta=M.Citta";
          ...
          <div class="blog_right_sidebar">
              ...
              <aside class="single_sidebar_widget post_category_widget">
                  ...
                  <ul class="list cat-list">
                      ...
                      <li>
                          <a href="trackdetails_222.php" href="#" class="d-flex">
                              <p>Ordine #222</p>
                          </a>
                      </li>
                      <li>
