                  ...
                  <div class="col-xl-5 col-lg-5">
                      ...
                      <table>
                        ...
                        $sql = "SELECT C.ID_Corriere, E.Citta, MT.Destinazione, MT.Citta_Corrente, C.Stato_Consegna
                                ...
                                WHERE C.ID_Ordine=111 AND C.ID_Corriere=MT.ID_Corriere AND E.ID_Magazzino=1 AND E.ID_Magazzino=M.ID_Magazzino AND E.ID_Ecommerce=M.ID_Ecommerce AND E.Citta=M.Citta";
